      ...
      <b-col md="8">
        <b-tabs content-class="mt-3" justified>
          <b-tab v-for="[key,val] in downs" :key="key" :title="key">
            <b-list-group>
              <b-list-group-item v-for="v1 in val.filter(el=>el.type === 'pdf')" :key="v1.title" :href="v1.href" class="d-flex justify-content-between align-items-center">
                {{ v1.title }}
                <b-badge>downLoad</b-badge>
              </b-list-group-item>
              <b-list-group-item v-for="v1 in val.filter(el=>el.type !== 'pdf')" :key="v1.title" :to="v1.link" class="d-flex justify-content-between align-items-center">
                {{ v1.title }}
              </b-list-group-item>
              <!-- <b-list-group-item
