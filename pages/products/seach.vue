  ...
  <b-container>
    <b-row no-gutters class="h-100">
      ...
      <b-col>
        <b-row no-gutters>
          <b-col
            v-for="(val, key) in all.slice(currentPage * 9 - 9, currentPage * 9)"
            :key="val.link + key"
            cols="12"
            md="4"
            class="p-4"
...
export default Vue.extend({
  ...
  head() {
    return {
      title: `UPS不间断电源厂家【价格 型号 参数 图片】- ${this.$store.state.name}`,
      meta: [
        {
          name: "keywords",
        ...
        },
        {
          name: "description",
          content:
            "雷迪司厂家生产商提供UPS电源，不间断电源，UPS不间断电源，包含UPS电源，不间断电源，UPS不间断电源品牌、参数、报价、价格、规格、大图片等，同时提供维修、维护、售后服务-深圳雷迪司科技股份有限公司",
        },
      ],
    };
  },
