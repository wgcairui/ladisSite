...
var RemoteServerAddress = 'https://www.ladishb.com/site';
var config = {
    telemetry: false,
    ssr: true,
    ...
    modern: 'server',
    server: {
        port: process.env.NODE_ENV === 'production' ? 9005 : 9005,
        host: '0.0.0.0'
    },
    env: {
    ...
    sitemap: {
        ...
        routes: function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1["default"].get(RemoteServerAddress + "/web/getRout", { headers: { name: encodeURI(process.env.NAME) } })];
                    case 1:
                        routs = _a.sent();
